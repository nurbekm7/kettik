...
class Languages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'kk_KZ:': {
          ...
          "sign_in_body": "Телефон нөміріңізбен кіріңіз немесе тіркеліңіз",
          "introTitle1": "Kettik қолданбасына қош келдіңіз!",
          "introTitle2":
              "Біз адамдарға бір-бірін табуға көмектесеміз. \n Шұғыл түрде бірдеңе жіберу керек және одан ақша табуға дайын адамдар",
          "introTitle3":
              "Сатып алуға тікелей шетелден дүкеннен тапсырыс беруге болады",
        ...
        'en_US': {
          "helloWorld": "Welcome",
          "sign_in_body": "Sign in with your phone number or register",
